...
in:
  ...
  and Berger B. Inference of admixture parameters and phylogeny using
  weighted linkage disequilibrium. [to appear on arXiv 11/1/12]
...
Version 0.92 is the first public release.
